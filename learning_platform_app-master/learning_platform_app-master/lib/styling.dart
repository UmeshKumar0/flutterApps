...
class AppTheme {
  ...
  static const Color titleMediumTextColor = Color(0xFF9F988F);
  ...
  static final TextStyle _titleMediumLight = TextStyle(
  ...
  static final TextStyle _titleLargeDark = _titleLargeLight.copyWith(color: Colors.white);

  static final TextStyle _titleMediumDark = _titleMediumLight.copyWith(color: Colors.white70);
